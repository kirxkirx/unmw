...
def wide_field_photometry_caveat_html():
    ...
    return (
        ...
        " many pixels.</li>\n"
        "<li><b>Low observing altitude:</b> the fields are often imaged only"
        " 15-20 degrees above the horizon. This is a deliberate trade-off for"
        " an all-sky transient search, as the sky area at low elevation is far"
        " larger than the area near the zenith, but it is bad for photometric"
        " accuracy. An airmass-dependent magnitude zero-point correction is"
        " applied, but it is not perfect.</li>\n"
